    ...
    <head>
        ...
        <!-- Ionicons -->
        <link href="<?php echo $is;?>://code.ionicframework.com/ionicons/1.5.2/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        ...
        <script src="<?php echo $is;?>://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
