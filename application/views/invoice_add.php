    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <form action="<?php echo base_url('invoices/index/add'); ?>" method="post">
                <div class="row">
                                ...
                                <table class="table table-striped">
                                        <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td align="right">invoices Date</td>
                                            <td>
                                               <div class="col-xs-5">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            ...
                                                            <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" name="invoice_date_created" REQUIRED>
                                                    </div>
                                                </div>
                                            </td>
                                               ...
                                               <div class="col-xs-5">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            ...
                                                            <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" name="invoice_valid_until" REQUIRED>
                                                    </div>
                                                </div>
                                            </td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                               ...
                                                               <strong>Invoice Subject</strong><br/>
                                                                    <textarea class="form-control" rows="3" placeholder="" name="invoice_subject"></textarea>
                                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                              ...
                                                              <strong>Invoice Terms</strong><br/>
                                                                    <textarea class="form-control" rows="3" placeholder="" name="invoice_customer_notes"></textarea>
                                                                </div>
...
<div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header" data-toggle="tooltip" title="" data-original-title="Item from products">
