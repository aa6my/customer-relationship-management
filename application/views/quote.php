                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                           ...
                           <!--  <button class="btn bg-blue pull-right"><i class="fa fa-credit-card"></i> Submit Payment</button> -->
                            ...
                            <button class="btn btn-warning btn-sm pull-right" style="margin-right: 5px;" onclick="window.location.href='<?php echo base_url(); ?>quotes/pdf/<?php echo $quote_id;?>'"><i class="fa fa-download"></i> 
                                
                                Generate PDF
                            </button>
                            <button class="btn btn-warning btn-sm pull-right" style="margin-right: 5px;" onclick="window.location.href='<?php echo base_url(); ?>quotes/send_mail/<?php echo $quote_id;?>'"><i class="fa  fa-envelope-o"></i> 
